...
barang = driver.find_element(By.XPATH, "//*[@id='wrapper']/nav/div/div/ul/li[2]/a/span[1]")
barang.click()
time.sleep(1)

persediaan = driver.find_element(By.XPATH, "//*[@id='wrapper']/nav/div/div/ul/li[2]/ul/li[2]/a/span")
persediaan.click()
time.sleep(5)
